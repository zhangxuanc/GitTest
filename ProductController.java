package com.zx.mall.controller.admin;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.zx.mall.controller.BaseController;
import com.zx.mall.entity.*;
import com.zx.mall.service.*;
import com.zx.mall.util.OrderUtil;
import com.zx.mall.util.PageUtil;
...
//333
    ...
    public String goToDetailsPage(HttpSession session,Map<String,Object> map,@PathVariable Integer pid/*产品ID*/){
        ...
        property.setPropertyCategoryId(product.getProductCategory());
    ...
    public String goToAddPage(HttpSession session,Map<String,Object> map){
        ...
        Property property=new Property();
        property.setPropertyCategoryId(categoryList.get(0));
        List<Property> propertyList=propertyService.select(property,null);
        map.put("propertyList",propertyList);
    ...
    //按类型ID查询属性-ajax
    @ResponseBody
    @RequestMapping(value = "admin/property/type{propertyCategoryId",method = RequestMethod.GET,produces = "application/json;char=utf-8")
    public String getPropertyByCategoryId(@PathVariable Integer propertyCategoryId){
        ...
        JSONObject object=new JSONObject();
        Property property=new Property();
        property.setPropertyCategoryId(category);
        List<Property> propertyList=propertyService.select(property,null);
